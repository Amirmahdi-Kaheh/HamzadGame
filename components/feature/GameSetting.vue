...
<template>
  <div>
    <button @click="isOpen = true" class="h-12 w-12 flex items-center justify-center rounded-lg border-2 border-[#D8C4B6] active:scale-90 transition-all">
      <Icon name="ph:gear-six-bold" size="20"></Icon>
    </button>
